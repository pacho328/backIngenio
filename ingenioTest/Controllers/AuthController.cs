...
namespace ingenioTest.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<ActionResult<string>> Login(UserDto request)
        {
            ...
            if (!VerifyPasswordHash(request.Password, userAuth.PasswordHash, userAuth.PasswordSalt))
            {
        ...
        private void SetUsersDB()
        {
            ...
            using (var client = new HttpClient()) 
            {
                ...
                if (result.IsSuccessStatusCode) 
                {
                    ...
                    var UsersRes = readtask.Result;

                    foreach (var us in UsersRes)
                    {
                        usersDto.Add(us);
                    }
                }
                ...
                foreach (var user in usersDto)
                {
                    ...
                    userT.PasswordHash = passwordHash;
                    userT.PasswordSalt = passwordSalt;
